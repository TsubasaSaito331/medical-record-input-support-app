...
export const ROUNDS_ITEM_LABEL_WITH_UNIT = {
  TEMPERATURE: `${ROUNDS_ITEM_LABEL.TEMPERATURE} (${ROUNDS_ITEM_UNITS.TEMPERATURE})`,
  PULSE: `${ROUNDS_ITEM_LABEL.PULSE} (${ROUNDS_ITEM_UNITS.PULSE})`,
  BLOOD_PRESSURE_HIGH: `${ROUNDS_ITEM_LABEL.BLOOD_PRESSURE_HIGH} (${ROUNDS_ITEM_UNITS.BLOOD_PRESSURE_HIGH})`,
  BLOOD_PRESSURE_LOW: `${ROUNDS_ITEM_LABEL.BLOOD_PRESSURE_LOW} (${ROUNDS_ITEM_UNITS.BLOOD_PRESSURE_LOW})`,
  RESPIRATION: `${ROUNDS_ITEM_LABEL.RESPIRATION} (${ROUNDS_ITEM_UNITS.RESPIRATION})`,
